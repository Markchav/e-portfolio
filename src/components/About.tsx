  ...
  return (
    ...
    <section id='about' className='snap-center'>
        <div className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl justify-evenly mx-auto items-center max-w-containerSmall py-10 lgl:py-32 gap-8'>
            ...
            <div className='flex flex-col lgl:flex-row gap-16 mt-[720px] xs:mt-[550px] sm:mt-[460px] lg:-mt-0'>
                ...
                <div className='w-full lgl:w-2/3 text-white font-medium flex flex-col gap-3 mt-20 sm:mt-0'>
                    ...
                    <p className='md:text-lg text-[15px] mt-5 sml:mt-0 '>{pageInfo?.backgroundInformationFirstParagraph}</p>
