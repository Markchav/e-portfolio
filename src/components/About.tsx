...
export default function About({ pageInfo }: Props) {
  return (
    ...
    <section id="about" className="snap-center">
      <div className="flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl justify-evenly mx-auto items-center max-w-contentContainer pt-40 pb-10 lgl:py-32 gap-8">
        ...
        <div className="flex flex-col lgl:flex-row gap-16 mt-[720px] xs:mt-[500px] sm:mt-[460px] lg:-mt-0">
          <div className="w-full lgl:w-2/3 text-white font-medium flex flex-col gap-3 mt-16 smx:-mt-20 md:mt-0">
            ...
            <p className="md:text-lg text-[15px] mt-10 sml:mt-0">
              {pageInfo?.backgroundInformationFirstParagraph}
            </p>
            <p className="md:text-lg text-[15px]">
              {" "}
              {pageInfo?.backgroundInformationSecondParagraph}{" "}
            </p>
            <p className="md:text-lg text-[15px]">
              {pageInfo?.backgroundInformationThirdParagraph}
            </p>
            <p className="md:text-lg text-[15px]">
            ...
            <div className="absolute w-full h-80 -left-6 -top-6 rounded-lg">
              <div className="w-full h-full relative z-20 flex pl-6 lgl:pl-0 ">
                <Image
                  ...
                  height={200}
                  alt=""
                  className="-mb-20 md:mb-0 flex-shrink-0 rounded-full object-cover md:rounded-lg mx-auto w-56 h-56 md:w-full md:h-80"
                />
