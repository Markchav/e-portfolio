...
export default function About({ pageInfo }: Props) {
  return (
    ...
    <section id="about" className="snap-center">
      <div className="flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl justify-evenly mx-auto items-center max-w-contentContainer py-10 lgl:py-32 gap-8">
