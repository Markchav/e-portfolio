...
export default function Navbar({ pageInfo, socials }: Props) {
  ...
  return (
    <div className="w-full shadow-navbarShadow h-20 lg:h-[7vh] fixed top-0 z-50 px-4 bg-[rgb(36,36,36)]">
        ...
        <div className="hidden mdl:inline-flex items-center gap-7">
          <ul className="flex text-[14px] gap-7">
            <Link
              ...
              className="flex items-center gap-1 font-medium text-white hover:text-[#F7AB0A]/50 cursor-pointer duration-300 nav-link"
            >
              <motion.li
          ...
          <a href="/assets/Resume-Mark-Chavez.pdf" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              <MdOutlineClose
                ...
                className="text-3xl text-white cursor-pointer hover:text-red-500 absolute top-5 right-5"
              />
              ...
              <div className="flex flex-col items-center text-[14px] gap-7 mt-20">
                ...
                <motion.a
                  ...
                  className="text-sm w-72 tracking-widest text-white text-center"
