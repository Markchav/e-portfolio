  ...
  return (
    <section id="contact" className="snap-start">
      <div className="h-screen relative flex flex-col text-center items-center md:text-left max-w-7xl mx-auto md:flex-row justify-evenly">
        ...
        <div className="flex flex-col space-y-10 md:mt-32 xs:mt-40 smx:mt-20 ">
          ...
          >
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                className="contactInput placeholder:p-1"
                type="text"
              />
              {errors.fullName && (
                <span className="mx-6 my-2 text-pink-500 text-sm">
